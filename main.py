...
class Root:
    ...
    def __init__(self, second, joke):
        # Countdown second
        self.second = second
        # Countdown function variable
        self.timer = None
        # Random prompt
        self.joke = joke
        # Root
        ...
        self.text_box.insert('end', self.joke)
        ...
        # Keep window open until close it manually
        self.root.mainloop()
    ...
    def start(self):
        ...
        self.start_button.config(stat='disabled')
...
response = requests.get(f'{RANDOM_API_URL}/joke')
result = response.json()['joke'] + ' '
